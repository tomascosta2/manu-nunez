    ...
    <div>
      ...
      <header className="bg-[#0051ff] max-w-[85%] w-[400px] rounded-full mt-8 md:mt-12 mx-auto">
        <div className="cf-container">
          <h3
            className="text-center text-[#f5f5f5] text-[14px] py-3 font-bold leading-[115%]"
          >
            {variant === 'A' && (
      ...
      <section className="mt-6 md:mt-8 pb-[60px] md:pb-[80px]">
        <div className="cf-container">
          <h1 className="text-center text-[20px] md:text-[32px] font-bold leading-[120%]">
            <span>
              BAJÁ ENTRE <span className="text-[#0051ff]">6 Y 15 KG DE GRASA CORPORAL Y TONIFICÁ EN 90 DÍAS</span> CON MI <span className="text-[#0051ff]">MÉTODO FIT90</span> - SIN DIETAS EXTREMAS NI RUTINAS IMPOSIBLES
            </span>
          </h1>
          <section className="relative">
            <div
              className="bg-[#0051ff] border-4 overflow-clip rounded-[12px] md:rounded-[16px] border-[#0051ff] mt-6 max-w-[750px] mx-auto"
            >
              ...
              <div
                className="bg-[#0051ff] aspect-video rounded-[8px] md:rounded-[12px] overflow-clip"
              >
      ...
      <section className="py-[60px] md:py-[80px] relative overflow-clip">
        <div className="cf-container">
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-8">
            <div>
              <p className="text-center py-2 bg-[#0051ff] text-black font-semibold">
                -17 KG en 3 Meses
              </p>
